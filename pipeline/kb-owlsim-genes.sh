...
$HOME/phenoscape-owl-tools/target/universal/stage/bin/kb-owl-tools pairwise-sim 100 $SLURM_ARRAY_TASK_ID $TARGET/kb/tbox-hierarchy-only.owl $TARGET/kb/profiles.ttl genes
