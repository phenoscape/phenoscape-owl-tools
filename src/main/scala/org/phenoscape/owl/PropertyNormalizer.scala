...
object PropertyNormalizer extends OWLTask {
  ...
  val properties = Map(
    IRI
      .create("http://purl.obolibrary.org/obo/OBO_REL_part_of") -> Vocab.part_of.getIRI,
    ...
    IRI.create(
      "http://purl.obolibrary.org/obo/mp/mp-equivalent-axioms-subq#part_of"
    ) -> Vocab.part_of.getIRI,
    IRI.create("http://purl.obolibrary.org/obo/OBO_REL_has_part") -> Vocab.has_part.getIRI,
    IRI
      .create("http://purl.obolibrary.org/obo/TODO_has_part") -> Vocab.has_part.getIRI,
    IRI.create("http://purl.obolibrary.org/obo/has_part") -> Vocab.has_part.getIRI,
    IRI.create(
      "http://purl.obolibrary.org/obo/mp/mp-equivalent-axioms-subq#has_part"
    ) -> Vocab.has_part.getIRI,
    IRI
      .create("http://purl.obolibrary.org/obo/emapa#has_part") -> Vocab.has_part.getIRI,
    ...
    IRI.create(
      "http://purl.obolibrary.org/obo/mp/mp-equivalent-axioms-subq#has_quality"
    ) -> Vocab.bearer_of.getIRI,
    ...
    IRI.create(
      "http://purl.obolibrary.org/obo/mp/mp-equivalent-axioms-subq#inheres_in"
    ) -> Vocab.inheres_in.getIRI,
    IRI.create(
      "http://purl.obolibrary.org/obo/mp/mp-equivalent-axioms-subq#inheres_in_part_of"
    ) -> Vocab.inheres_in_part_of.getIRI,
    IRI
      .create("http://purl.obolibrary.org/obo/BFO_0000052") -> Vocab.inheres_in.getIRI,
    IRI.create("http://purl.obolibrary.org/obo/overlaps") -> IRI.create(
      "http://purl.obolibrary.org/obo/RO_0002131"
    ),
    IRI.create("http://purl.obolibrary.org/obo/RO_overlaps") -> IRI.create(
      "http://purl.obolibrary.org/obo/RO_0002131"
    ),
    IRI
      .create("http://purl.obolibrary.org/obo/towards") -> Vocab.towards.getIRI,
    IRI
      .create("http://purl.obolibrary.org/obo/OBO_REL_towards") -> Vocab.towards.getIRI,
    ...
    IRI.create(
      "http://purl.obolibrary.org/obo/mp/mp-equivalent-axioms-subq#towards"
    ) -> Vocab.towards.getIRI,
    IRI.create(
      "http://purl.obolibrary.org/obo/hp/hp-logical-definitions#involves"
    ) -> Vocab.involves.getIRI,
    IRI.create(
      "http://purl.obolibrary.org/obo/mp/mp-equivalent-axioms-subq#occurs_in"
    ) -> Vocab.occurs_in.getIRI
  )
