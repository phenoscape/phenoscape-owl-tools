  ...
  def computeInferences(mainOntology: OWLOntology, targetOntology: OWLOntology): Unit = {
    ...
    while (newAxiomCount > oldAxiomCount) {
      ...
      MaterializeInferences
        .materializeInferences(mainOntology, MaterializeInferences.createReasoner(mainOntology, "elk"));
      ...
      targetOntology
        ...
        .saveOntology(targetOntology, IRI.create(new File("/Users/jim/Desktop/target.owl")));
      MaterializeInferences
        .materializeInferences(targetOntology, MaterializeInferences.createReasoner(targetOntology, "trowl"));
