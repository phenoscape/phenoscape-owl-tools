...
object Vocab {
  ...
  val inheres_in_part_of = ObjectProperty(
    "http://purl.obolibrary.org/obo/RO_0002314"
  )
  val EXHIBITS = ObjectProperty("http://purl.org/phenoscape/vocab.owl#exhibits")
  val DEVELOPS_FROM = ObjectProperty(
    "http://purl.obolibrary.org/obo/RO_0002202"
  )
  val NEGATES =
    IRI.create("http://purl.org/phenoscape/vocab.owl#negation_of_class")
  val entity_term = AnnotationProperty(
    "http://purl.org/phenoscape/vocab.owl#entity_term"
  )
  val quality_term = AnnotationProperty(
    "http://purl.org/phenoscape/vocab.owl#quality_term"
  )
  val related_entity_term = AnnotationProperty(
    "http://purl.org/phenoscape/vocab.owl#related_entity_term"
  )
  val may_have_state_value = ObjectProperty(
    "http://purl.org/phenoscape/vocab.owl#may_have_state_value"
  )
  val subclade_of = ObjectProperty(
    "http://purl.org/phenoscape/vocab.owl#subclade_of"
  )
  val has_member = ObjectProperty(
    "http://purl.org/phenoscape/vocab.owl#has_member"
  )
  val Taxon = Class("http://rs.tdwg.org/dwc/terms/Taxon")
  val CharacterStateDataMatrix = Class(
    "http://purl.obolibrary.org/obo/CDAO_0000056"
  )
  val has_character = ObjectProperty(
  ...
  val has_external_reference = ObjectProperty(
    "http://purl.obolibrary.org/obo/CDAO_0000164"
  )
  val belongs_to_character = ObjectProperty(
    "http://purl.obolibrary.org/obo/CDAO_0000205"
  )
  val belongs_to_TU = ObjectProperty(
  ...
  val individual_id = ObjectProperty(
  ...
  val catalogNumber = factory.getOWLDataProperty(
    IRI.create("http://rs.tdwg.org/dwc/terms/catalogNumber")
  )
  ...
  val associated_with_gene = ObjectProperty(
    "http://purl.org/phenoscape/vocab.owl#associated_with_gene"
  )
  val ANNOTATED_ORGANISM = ObjectProperty(
    "http://purl.org/phenoscape/vocab.owl#annotated_organism"
  )
  val HAS_EXACT_SYNONYM =
    IRI.create("http://www.geneontology.org/formats/oboInOwl#hasExactSynonym")
  val HAS_RELATED_SYNONYM =
    IRI.create("http://www.geneontology.org/formats/oboInOwl#hasRelatedSynonym")
  val associated_with_taxon = ObjectProperty(
  ...
  val XENOPUS_LAEVIS =
    IRI.create("http://purl.obolibrary.org/obo/NCBITaxon_8355")
  val XENOPUS_TROPICALIS =
    IRI.create("http://purl.obolibrary.org/obo/NCBITaxon_8364")
  ...
  val AppendageGirdleComplex = Class(
    "http://purl.obolibrary.org/obo/UBERON_0010707"
  )
  val HOMOLOGOUS_TO = ObjectProperty(
    "http://purl.obolibrary.org/obo/RO_0002158"
  )
  val DERIVED_BY_DESCENT_FROM = ObjectProperty(
    "http://purl.obolibrary.org/obo/RO_0002156"
  )
  val HAS_DERIVED_BY_DESCENDANT = ObjectProperty(
    "http://purl.obolibrary.org/obo/RO_0002157"
  )
  val has_evidence = ObjectProperty("http://purl.obolibrary.org/obo/RO_0002558")
  val axiom_has_evidence = AnnotationProperty(
    "http://purl.obolibrary.org/obo/RO_0002612"
  )
  val ANATOMICAL_ENTITY =
    IRI.create("http://purl.obolibrary.org/obo/UBERON_0001062")
  ...
  val connected_to = ObjectProperty(
    IRI.create("http://purl.obolibrary.org/obo/core#connected_to")
  )
  val list_index = factory.getOWLAnnotationProperty(
    IRI.create("http://purl.org/phenoscape/vocab.owl#list_index")
  )
  val state_symbol = factory.getOWLAnnotationProperty(
    IRI.create("http://purl.org/phenoscape/vocab.owl#state_symbol")
  )
  val exhibits_state = ObjectProperty(
    "http://purl.org/phenoscape/vocab.owl#exhibits_state"
  )
  val describes_phenotype = AnnotationProperty(
    "http://purl.org/phenoscape/vocab.owl#describes_phenotype"
  )
  val has_presence_of = ObjectProperty(
    "http://purl.org/phenoscape/vocab.owl#has_presence_of"
  )
  val has_absence_of = ObjectProperty(
    "http://purl.org/phenoscape/vocab.owl#has_absence_of"
  )
  val has_phenotypic_profile =
    IRI.create("http://purl.org/phenoscape/vocab.owl#has_phenotypic_profile")
  val phenotype_of = ObjectProperty(
    "http://purl.org/phenoscape/vocab.owl#phenotype_of"
  )
  val phenotype_of_part_of = ObjectProperty(
    "http://purl.org/phenoscape/vocab.owl#phenotype_of_reflexive_part_of"
  )
  val has_part_inhering_in = ObjectProperty(
  ...
  val combined_score = ObjectProperty(
    "http://purl.org/phenoscape/vocab.owl#combined_score"
  )
  val has_ic = ObjectProperty("http://purl.org/phenoscape/vocab.owl#has_ic")
  val has_expect_score = ObjectProperty(
    "http://purl.org/phenoscape/vocab.owl#has_expect_score"
  )
  val has_subsumer = ObjectProperty(
    "http://purl.org/phenoscape/vocab.owl#has_subsumer"
  )
  val for_query_profile = ObjectProperty(
    "http://purl.org/phenoscape/vocab.owl#for_query_profile"
  )
  val for_corpus_profile = ObjectProperty(
    "http://purl.org/phenoscape/vocab.owl#for_corpus_profile"
  )
  val for_query_annotation = ObjectProperty(
    "http://purl.org/phenoscape/vocab.owl#for_query_annotation"
  )
  val for_corpus_annotation = ObjectProperty(
    "http://purl.org/phenoscape/vocab.owl#for_corpus_annotation"
  )
