...
object SimilarityTemplates {
  ...
  def developsFromEntity(entity: OWLClass): (OWLClass, Set[OWLAxiom]) = ExpressionUtil.nameForExpressionWithAxioms(has_part some (phenotype_of some (DEVELOPS_FROM some entity)))
